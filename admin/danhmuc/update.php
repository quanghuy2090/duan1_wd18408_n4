...
<div class="container">
    <h1>CẬP NHẬT DANH MỤC</h1>
        <form action="index.php?act=updatedm" method="POST" class="col-md-3">
            <div class="col-auto">
                <label> Mã loại </label> <br>
                <input class="form-control" name="maloai" type="text" placeholder="Nhập vào mã loại" aria-label="default input example"><br>

                <label>Tên loại </label> <br>
                <input class="form-control" placeholder="Nhập vào tên loại" aria-label="default input example" type="text" name="tenloai" value="<?php if(isset($name)&&($name!="")) echo $name;?>" ><br>
            </div>
            <div class="g-3">
